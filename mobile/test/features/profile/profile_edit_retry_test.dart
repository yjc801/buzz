...
void main() {
  ...
  testWidgets('standalone Flutter text draft survives Back while saving', (
    tester,
  ) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.android;
    addTearDown(() => debugDefaultTargetPlatformOverride = null);
    ...
    await tester.pump();
    expect(find.byKey(const ValueKey('profile-field-input')), findsOneWidget);
    expect(
      tester
          .widget<IconButton>(find.byKey(const ValueKey('profile-field-close')))
          .onPressed,
      isNull,
    );
    ...
    await tester.pumpAndSettle();
    expect(
      find.text("We couldn't save this change. Try again."),
      findsOneWidget,
    );
    expect(
      tester
          .widget<Semantics>(
            find
                .ancestor(
                  of: find.text("We couldn't save this change. Try again."),
  ...
  testWidgets('in-page Flutter text draft survives Back while saving', (
    tester,
  ) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.android;
    addTearDown(() => debugDefaultTargetPlatformOverride = null);
